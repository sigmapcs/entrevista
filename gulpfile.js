...
const
    ...
    files ={
        ...
        css:[
            ...
            `${dir.nm}/baguettebox.js/dist/animate.min.css`,
            `${dir.nm}/baguettebox.js/dist/baguetteBox.css`,
            `${dir.nm}/datepickr/dist/datepickr.css`,
            `${dir.nm}/flickity/dist/flickity.min.js`,
            `${dir.nm}/photoswipe/dist/photoswipe.css`,
            `${dir.nm}/photoswipe/dist/photoswipe.css`,
        ...
        mJS: 'scripts.min.js',
        JS:[
            // `${dir.nm}/sizzle/dist/sizzle.js`,
            // `${dir.nm}/jquery/dist/jquery.js`,
            `${dir.nm}/baguettebox.js/dist/baguetteBox.js`,
            `${dir.nm}/cleave.js/dist/cleave.js`,
            `${dir.nm}/datepickr/dist/datepickr.js`,
            `${dir.nm}/flickity/dist/flickity.pkgd.js`,
            `${dir.nm}/photoswipe/dist/photoswipe.js`,
            `${dir.nm}/photoswipe/dist/photoswipe-ui-default.js`,
            `${dir.nm}/scroll-entrance/dist/scroll-entrance.js`,
            `${dir.dev}/assets/js/smooth-scroll.min.js`,
            `${dir.nm}/aja/src/aja.min.js`
